...
const navItems = [
  ...
  { path: '/team/projects', label: 'Projects', icon: FolderKanban },
        ...
        <div className="flex flex-col flex-1 bg-zinc-900/50 border-r border-zinc-800">
          ...
          <div className="p-4 border-t border-zinc-800">
            <div className="flex items-center gap-3 px-4 py-3 rounded-xl bg-zinc-800/30">
              <div className="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-400 to-teal-500 flex items-center justify-center text-zinc-900 font-bold text-sm">
